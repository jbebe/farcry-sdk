...
their controls. It is a ceiling on lines, not on content — FCSE shows more by keeping a window over
its own list of rows and rebuilding every line when the window moves. Its window is 17 rather than
20, because the menu's frame crowds the last three of the twenty past readability.
