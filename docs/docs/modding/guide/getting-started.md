...
So, the first thing to do is unpack the patch.fat/.dat files. If you are starting from scratch these can be found in the “Data_Win32” folder within your Far Cry 2 folder. Otherwise you can use patch.fat/.dat files from any mod or those that accompany this guide.
...
1. Each map has it’s own “entitylibrary.fcb” file. For map 1 (North) it is found in \patch_unpack\worlds\world1\generated\ and for map 2 (South) it is found within \patch_unpack\worlds\world2\generated\\. You can unpack the “entitylibrary.fcb” files for whatever map you are editing.
...
1. Unpack “entitylibrary.fat/.dat” from your Far Cry 2 folder, within \Far Cry 2\Data_Win32\downloadcontent\dlc1\\.
