...
To link our changes to the controls system we need to first find which action map the control is located under. There are several action maps in this file, under titles like this: \<ActionMap name="common_weapons"\>

Once you’ve found the right section, we need to add a new line to the group directly under the title. There is a list of “Import actionmap” lines, and we’re going to create a new one, for example: \<Import actionmap="common_holster_remap" optional=""/\>
